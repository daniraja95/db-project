...
<head>
    ...
    <!-- dependencies styles -->
    <link rel="stylesheet" href="dependencies/fontawesome/css/font-awesome.css" />
    <link rel="stylesheet" href="dependencies/metisMenu/dist/metisMenu.css" />
    <link rel="stylesheet" href="dependencies/animate.css/animate.css" />
...
<!-- Left sidebar Menu -->
    <div id="left-sidebar" class="animated fadeIn">
        ...
        <ul class="nav" id="side-menu">
            <li>
                <a href="#"> <span class="nav-label">Dashboard</span><span class="fa arrow"></span> </a>
                <ul class="nav nav-second-level">
                    ...
                    <li><a href="index-4.html">Dashboard Layout 4</a></li>
                    <li><a href="index-5.html">Dashboard Layout 5</a></li>
                    <li><a href="index-6.html">Dashboard Layout 6</a></li>
                </ul>
            </li>
            <li>
                <a href="#"><span class="nav-label">UI Elements</span><span class="fa arrow"></span> </a>
                <ul class="nav nav-second-level">
            ...
            <li>
                <a href="#"><span class="nav-label">Spec Pages</span><span class="fa arrow"></span> </a>
                <ul class="nav nav-second-level">
                    <li><a href="contacts.html">Contacts</a></li>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="specpanel">
                    ...
                    <span class="pull-right">
                          This is standard panel footer <a href="#">Right Side</a>
                    </span>
                        ...
                        <div class="m-t-xl">
                            ...
                            <div class="feed-element">
                              ...
                              <div class="media-body ">
                               ...
                               <strong>{{$a->a_name}}</strong>&nbsp;&nbsp;{{$a->a_activity}} 
                               <br>
 ...
 -->
                ...
                <div class="specpanel">
                    ...
                    <div class="panel-body list">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="active">
                                <a data-toggle="tab" href="#chat-1">James</a>
                            </li>
                            <li>
                                <a data-toggle="tab" href="#chat-2">Jane</a>
                            </li>
                            <li>
                                <a data-toggle="tab" href="#chat-3">Smith</a>
                            </li>
                        </ul>
                        <div class="tab-content no-padding">
                            <div class="tab-pane active cont" id="chat-1">
                                <div class="chat-wi">
                                    ...
                                    <div class="chat-in">
                                        <form action="#" id="sd" method="post" name="sd">
                    ...
                    <div class="specpanel">
                        ...
                        <div class="panel-body list">
                            ...
                            <div class="pull-right">
                                ...
                                <a href="#" class="btn btn-xs btn-default">Yesterday</a>
                            </div>
                        ...
                        @foreach($prod as $p)
                             <li class="list-group-item listitemactivty"><span class="label label-info">{{ $p->id}} </span>
                                 {{ $p->p_task}} 
                                  
                                <!--  <a href="{{"delete".$p['id']}} class="btn btn-danger pull-right">Delete</a> -->

                                <a href="{{"delete".$p['id']}}" class="btn btn-danger pull-right"><i class="fa fa-trash"></i></a>
                                <a href="{{"delete".$p['id']}}" class=" pull-right"><i class="fa fa-edit"></i></a>
            ...
            @endif
                        <br>
                         ...
                         <div class="chat-in">
                                        <form action="submit" id="sd1" method="post" name="sd">
                                            @csrf 
                                            <div class="input">
                                                <input name="p_task" class="form-control form-control-lg"placeholder="Add a new task ..." type="text">
                                            </div>
                                            <br>
                                             <input class="btn btn-success form-control form-control-lg" type="submit" value="SEND">
...
<script src="dependencies/slimScroll/jquery.slimscroll.js"></script>
<script src="dependencies/bootstrap/dist/js/bootstrap.js"></script>
<script src="dependencies/metisMenu/dist/metisMenu.js"></script>
<script src="dependencies/iCheck/icheck.js"></script>
